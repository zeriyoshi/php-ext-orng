...
docker run --rm -v"$(pwd)/../:/work:cached" -it php:7.0-cli "/work/util/data_gen.php" "shuffle_rand" "/work/tests/data"

# generate PHP 7.0 (glibc) srand() based array_rand() result table.
docker run --rm -v"$(pwd)/../:/work:cached" -it php:7.0-cli "/work/util/data_gen.php" "array_rand_rand" "/work/tests/data"

# generate PHP 7.0 (glibc) srand() based str_shuffle() result table.
docker run --rm -v"$(pwd)/../:/work:cached" -it php:7.0-cli "/work/util/data_gen.php" "str_shuffle_rand" "/work/tests/data"
...
docker run --rm -v"$(pwd)/../:/work:cached" -it php:7.2-cli "/work/util/data_gen.php" "shuffle_mt" "/work/tests/data"

# generate PHP 7.2 mt_srand() based array_rand() result table.
docker run --rm -v"$(pwd)/../:/work:cached" -it php:7.2-cli "/work/util/data_gen.php" "array_rand_mt" "/work/tests/data"

# generate PHP 7.3 mt_srand() based str_shuffle() result table.
# Note: PHP 7.2 and lower implementation based old srand().
docker run --rm -v"$(pwd)/../:/work:cached" -it php:7.3-cli "/work/util/data_gen.php" "str_shuffle_mt" "/work/tests/data"
